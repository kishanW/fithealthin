				...
				<div id="post-body-content" class="arq-content">
					...
					<div class="postbox" id="linkedin">
						...
						<div class="inside">
							...
							<div><strong><?php _e( 'Need Help?' , 'arq' ) ?></strong><p><em><?php _e( 'Enter Your LinkedIn Company ID click on Get Access Token link to get your app Access Token,' , 'arq' ) ?> <a href="http://plugins.tielabs.com/docs/arqam/#linkedin" target="_blank"><?php _e( 'Click Here' , 'arq' ) ?></a> <?php _e( 'For More Details.' , 'arq' ) ?></em></p></div>
							<div class="clear"></div>
						</div>
					</div> <!-- Box end /-->
